...
class BasicBlockDec(nn.Module):
    def __init__(self, in_planes:int, stride:int = 1):
        ...
        self.conv2 = nn.Conv2d(in_planes, in_planes, kernel_size = 3, stride = 1, padding = 1, bias = False) # TODO: Why are in_planes here twice? 
...
class ResNet18Enc(nn.Module):
    ...
    def __init__(self, num_Blocks:list=[2, 2, 2, 2], z_dim:int = 10, nc:int = 3): 
        ...
        self.conv1 = nn.Conv2d(in_channels=nc, out_channels=64, kernel_size=3, 
...
class ResNet18Dec(nn.Module):
    ...
    def _make_layer(self, BasicBlockDec, planes, num_Blocks, stride):
        ...
        self.in_planes = planes # TODO: why is this outside of the for-loop here, but inside the for-loop for the Encoder?
        return nn.Sequential(*layers)
...
class VAEResNet18(nn.Module): # defines a new class called VAEResNet18 that inherits from nn.Module, which is the base class for all neural netowrks in PyTorch
    """
    Args:
        nc (int): Number of channels
        z_dim (int): Dimensionality of the latent space
